...
public class PresetOptions {
    ...
    @CommandLine.Option(names = {"-m", "--matrix"}, description = "Path of matrix summary (xlsx format) (- to disable).", defaultValue = "ktmatrix.xlsx")
    ...
    @CommandLine.Option(names = {"-r", "--report"}, description = "Path of test report (JUnit format) (- to disable).", defaultValue = "ktreport.xml")
