...
@CommandLine.Command(name = "ktest", description = "Kafka testing utility.",
        ...
        subcommands = {SRunCommand.class, PRunCommand.class, DocCommand.class, EvalCommand.class, ScanCommand.class, McpCommand.class})
...
public class MainCommand {
    public static final String VERSION = "ktest v1.0.34";
